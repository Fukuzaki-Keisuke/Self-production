...
//敵カウントの初期化
int EnemyActorBase::mEnemyCount = 0;
int EnemyActorBase::mNearEnemyCount = 0;
...
void EnemyActorBase::PlayAnimation(EnemyStateEnum state, float rate)
{
